...
var motorRunning = {'1': false, '2': false, '3': false, '4': false};
var motorPos = {'1': 0, '2': 0, '3': 0, '4': 0};
var motorPosExact = {'1': 0, '2': 0, '3': 0, '4': 0};
var motorConnected = [false, false, false, false];
var motorAttachment = [null, null, null, null];
var motorBacklash = {'1': 0, '2': 0, '3': 0, '4': 0};
...
st4.btServiceIds = [currentNMX, legacyNMX];
st4.connect = connect;
st4.disconnect = disconnect;
st4.disable = disable;
st4.enable = enable;
st4.move = move;
st4.constantMove = constantMove;
st4.getStatus = getStatus;
st4.resetMotorPosition = resetMotorPosition;
st4.setMotorPosition = setMotorPosition;
st4.checkMotorAttachment = checkMotorAttachment;
st4.setMotorAttachment = setMotorAttachment;
st4.setMotorBacklash = setMotorBacklash;
st4.getMotorBacklash = getMotorBacklash;
...
function readData(cb) {
    console.log("st4: readData " + JSON.stringify(cb) );
...
function _connectBt(btPeripheral, callback) {
    console.log("st4: _connectBt " + JSON.stringify(btPeripheral) + "\n" + JSON.stringify(callback) );
...
function _queueCommand(object, callback) {
    console.log("st4: _queueCommand " + JSON.stringify(object) + "\n" + JSON.stringify(callback) );
...
function _runQueue(queueItem, rec) {
    console.log("st4: _runQueue " + JSON.stringify(queueItem) + "\n" + JSON.stringify(queueItem) );
...
function _parseNMXData(dataBuf) {
    console.log("st4: _parseNMXData " + JSON.stringify(dataBuf));
